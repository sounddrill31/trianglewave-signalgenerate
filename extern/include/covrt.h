...
class ICovrtSimulinkSessionInterface;
#else
typedef struct CovrtSimulinkInstance          CovrtSimulinkInstance;
typedef struct ICovrtSimulinkSessionInterface ICovrtSimulinkSessionInterface;
#endif
...
/*
 * MATLAB INTERNAL USE ONLY :: Initialize Relational Boundary
 */
EXTERN_C LIBCOVRT_API void covrtRelationalBoundaryInitFcn(covrtInstance* instance,
                                                          unsigned int   cvId,
                                                          unsigned int   objIdx,
                                                          int            charStart,
                                                          int            charEnd,
...
/*
 * MATLAB INTERNAL USE ONLY :: Log Relational
 */

EXTERN_C LIBCOVRT_API int32_T covrtLogRelational(covrtInstance* instance,
                                                 uint32_T       covId,
 ...
 */
EXTERN_C LIBCOVRT_API bool covrtLogCond(covrtInstance* instance,
                                        uint32_T       covId,
                                        uint32_T       fcnId,
                                        int32_T        condId,
                                        int32_T        condition);
...
EXTERN_C LIBCOVRT_API void covrtSimulinkSessionInit(void* sessionInterface, const char* model);
EXTERN_C LIBCOVRT_API void covrtRapidAccelStreamingSessionInit(ICovrtSimulinkSessionInterface* sessionInterface);
EXTERN_C LIBCOVRT_API void covrtClearSimulinkInstances();
...
EXTERN_C LIBCOVRT_API bool covrtIsModelAccelStarted(const char* aModel);
EXTERN_C LIBCOVRT_API void covrtMarkRootUpdateDataIdxExecuted(const char* aModel);
EXTERN_C LIBCOVRT_API bool covrtIsRootUpdateDataIdxExecuted(const char* aModel);

EXTERN_C LIBCOVRT_API CovrtSimulinkInstance* covrtAllocateSimulinkInstance(CovrtSimulinkInstance* instance, const char* modelName);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkBlockCovInit(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx, const char* blockSID, bool updateAtStart);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecCovInit(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx, const char* blockPath, int64_T vecSize, int64_T numOutcomes, uint32_T outcomeOffset, const char* decDescr, const char* outcomeStrId, const char* customText, bool hasVariableOutcomes, int64_T offset, bool useModifiedComplexityVal, bool collapseVector, const char** outcomeStrs, uint32_T outcomeStrSize, const char** descrVec, uint32_T descrVecSize);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecInterlacedCovInit(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx, const char* blockSID, int64_T vecSize, int64_T numOutcomes, uint32_T outcomeOffset, const char* decDescr, const char* outcomeStrId, const char* customText, bool hasVariableOutcomes, int64_T offset, bool useModifiedComplexityVal, bool collapseVector, const char** outcomeStrs, uint32_T outcomeStrSize, const char** descrVec, uint32_T descrVecSize, const char** decisionInterlacedDescr, const char** customInterlacedTxt);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkCondCovInit(CovrtSimulinkInstance* instance, const int blockSysIdx, const int blockIdx, const char* blockPath, const int condDescrVecIdx, const int64_T numOfConditions, const char* conditionDescr, const uint32_T numOfMcdcs, const char* mcdcDescr, const bool isCascMCDC, const uint32_T maxDescrParams, const bool hasVariableSize, const int mcdcExprType, const char** descrVec, const int64_T* descrIdxVec, const uint32_T descrVecSize, const char** opDesc, const uint32_T opDescSize, const int* pptVec, const uint32_T pptSize);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkBlockInitCovRecording(CovrtSimulinkInstance* instance, const char** blockPathsVec, const uint32_T blockPathsVecSize);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkBlockCovRecordUsingBaseIdx(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkBlockCovRecord(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecCovRecordUsingBaseIdx(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecCovRecordOutcomeList(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal, const int aOutcomeIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecCovRecordActiveVarSize(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal, const unsigned int aActiveOutcomeIdx, const unsigned int aNumOutcomes);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecCovRecordOutcomeListActiveVarSize(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal, const int aOutcomeIdx, const unsigned int aActiveOutcomeIdx, const unsigned int aNumOutcomes);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecCovRecord(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx, unsigned int checkExprVal, int64_T vecId, bool isOutcomesListPresent, int outcomeIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkDecInterlacedCovRecord(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx, unsigned int outcomeVal, int interlacedIdx, int64_T vecId);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkCondCovRecordUsingBaseIdx(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkCondCovRecordActiveVarSize(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal, const unsigned int aActiveOutcomeIdx, const unsigned int aCondIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkCondCovRecord(CovrtSimulinkInstance* instance, const int blockSysIdx, const int blockIdx, const int condDescrVecIdx, const bool outcomeVal, const int condIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkMCDCInpCovRecord(CovrtSimulinkInstance* instance, const int blockSysIdx, const int blockIdx, const int condDescrVecIdx, const bool outcomeVal, const int mcdcIdx, const int predIdx);
EXTERN_C LIBCOVRT_API void                   covrtSimulinkMCDCOutCovRecord(CovrtSimulinkInstance* instance, const int blockSysIdx, const int blockIdx, const int condDescrVecIdx, const bool outcomeVal, const int mcdcIdx);

/* Streaming Coverage Entry points */
EXTERN_C LIBCOVRT_API void covrtSimulinkDecCovStreamUsingBaseIdx(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal, double aTime);
EXTERN_C LIBCOVRT_API void covrtSimulinkDecCovStreamOutcomeList(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const unsigned int aOutcomeVal, const int aOutcomeIdx, double aTime);
EXTERN_C LIBCOVRT_API void covrtSimulinkDecCovStream(CovrtSimulinkInstance* instance, int blockSysIdx, int blockIdx, unsigned int checkExprVal, int64_T vecId, bool isOutcomesListPresent, int outcomeIdx, double time);
EXTERN_C LIBCOVRT_API void covrtSimulinkDecInterlacedCovStream(CovrtSimulinkInstance* instance, const int blockSysIdx, const int blockIdx, const unsigned int outcomeVal, const int interlacedIdx, const int64_T vecId, double time);
EXTERN_C LIBCOVRT_API void covrtSimulinkCondCovStreamUsingBaseIdx(CovrtSimulinkInstance* aInstance, const unsigned int aCovBaseIdx, const bool aOutcomeVal, double aTime);
EXTERN_C LIBCOVRT_API void covrtSimulinkCondCovStream(CovrtSimulinkInstance* instance, const int blockSysIdx, const int blockIdx, const int condDescrVecIdx, const bool outcomeVal, const int condIdx, double time);
EXTERN_C LIBCOVRT_API void covrtSimulinkInstanceEnter(CovrtSimulinkInstance* instance, const char* refModelName, int sysIdx, int blockInstanceIdx, double time);
EXTERN_C LIBCOVRT_API void covrtSimulinkInstanceExit(CovrtSimulinkInstance* instance, int sysIdx, int blockInstanceIdx, double time);
EXTERN_C LIBCOVRT_API void covrtStopAsyncLogging();
EXTERN_C LIBCOVRT_API void covrtSerializeCoverageStreamData();
EXTERN_C LIBCOVRT_API void covrtCollectPerformanceData(const char* modelName);
...
EXTERN_C LIBCOVRT_API unsigned int covrtSigUpdateFcnAssumingCovEnabled(CovrtStateflowInstance* instance,
                                                                       unsigned int            dataNumber,
                                                                       double                  equivValue);

EXTERN_C LIBCOVRT_API unsigned int covrtIsSigCovEnabledFcn(CovrtStateflowInstance* instance,
                                                           unsigned int            dataNumber);
