...
ASYNCIOQUEUE_EXPORT_EXTERN_C sdiAsyncRepoDataTypeHandle sdiAsyncRepoGetBuiltInDataTypeHandleForDSM(
...
ASYNCIOQUEUE_EXPORT_EXTERN_C sdiAsyncRepoDataTypeHandle sdiAsyncRepoCreateAliasedDataTypeForDSM(
    sdiAliasedName aliasedName,
    const int slDataTypeID);
...
ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiHelperAsyncRepoCreateAsyncioQueueForDSMv2(
    const sdiAsyncRepoDataTypeHandle dTypeHandle,
    const char_T* const dsName,
    const char_T* const logName,
    const char_T* const mdlRefPath,
    const char_T* const blockPath,
    const int numDims,
    const SLSize* dims,
    const int dimsModeInt,
    const int complexityInt,
    const int sampleTimeContinuityInt,
    const char_T* const units,
...
ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiSetDateTimeTypeMetadata(
    ...
    const char_T* storageDataType,
    const char_T* dataTypeName);

ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiSetDateTimeTypeMetadataToBusHierarchyLeaf(
    sdiHierarchyDefinition parentHier,
    const int timePoint,
    const int timeStandard,
    const char_T* storageDataType,
...
ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiWriteSignalForDSM(
    ...
    const char_T* const memoryBlockPath,
    const int dsmTypeInt,
    const double time,
    const void *const data);
...
ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiRegisterAllDSRefsForDSM(
    const char_T* const mdlRefPath,
    const char_T* const parentMemoryBlockPath,
    const int numChildDSMs,
    const char_T** childMemoryBlockPaths);
...
ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiTerminateStreamingForDSM(
    const char_T* const mdlRefPath,
    const char_T* const blockPath,
    const int dsmTypeInt);
...
ASYNCIOQUEUE_EXPORT_EXTERN_C void sdiAsyncRepoShowInSDI(
    sdiAsyncQueueHandle hQueue,
    const sdiSignalPathToLeafElemU leafName);
