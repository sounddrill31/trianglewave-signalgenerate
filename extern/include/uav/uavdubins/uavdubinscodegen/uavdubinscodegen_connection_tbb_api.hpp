...
/**
 * @file
 * External C-API interfaces for UAV Dubins motion primitive calculations (TBB-accelerated).
...
EXTERN_C UAVDUBINSCODEGEN_API void* uavDubinsConnectionObj_tbb(const double airSpeed,
 ...
 */
EXTERN_C UAVDUBINSCODEGEN_API void uavDubinsConnectionObjCleanup_tbb(void* connObj);
