 ...
 * @param[in] segmentDirections Direction of the Reeds-Shepp's 5 segments, specified as
 *   int32_T precision 5-vector.
 ...
 *   Reeds-Shepp curve, returned as a (@p numSteps)-by-1 double-precision vector.
 */
