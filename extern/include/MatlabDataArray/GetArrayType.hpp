...
namespace matlab {
    namespace data {
        ...
        template<> struct GetArrayType<SparseArray<float>> { static const ArrayType type = ArrayType::SPARSE_SINGLE; };
        template<> struct GetArrayType<SparseArray<std::complex<double>>> { static const ArrayType type = ArrayType::SPARSE_COMPLEX_DOUBLE; };
        template<> struct GetArrayType<SparseArray<std::complex<float>>> { static const ArrayType type = ArrayType::SPARSE_COMPLEX_SINGLE; };
        ...
        template<> struct GetSparseArrayType<float> { static const ArrayType type = ArrayType::SPARSE_SINGLE; };
        template<> struct GetSparseArrayType<std::complex<double>> { static const ArrayType type = ArrayType::SPARSE_COMPLEX_DOUBLE; };
        template<> struct GetSparseArrayType<std::complex<float>> { static const ArrayType type = ArrayType::SPARSE_COMPLEX_SINGLE; };
    }
}
