    ...
    namespace data {
            ...
            struct ApplyVisitor
            {
                ...
                return_type operator()(A a, V visitor) const
                {
                    switch (a.getType()) {
                      ...
                      case ArrayType::SPARSE_SINGLE:         return invokeVisitor(SparseArray<float>(std::forward<A>(a)), std::forward<V>(visitor));
                      ...
                      case ArrayType::SPARSE_COMPLEX_SINGLE: return invokeVisitor(SparseArray<std::complex<float>>(std::forward<A>(a)), std::forward<V>(visitor));                      
                      default:
          ...
          -> decltype (visitor(static_cast<CharArrayRef>(a)))
        {
            switch (a.getType()) {
              ...
              case ArrayType::SPARSE_SINGLE:         return visitor(static_cast<SparseArrayRef<float>>(a));
              case ArrayType::SPARSE_COMPLEX_DOUBLE: return visitor(static_cast<SparseArrayRef<std::complex<double>>>(a));
              case ArrayType::SPARSE_COMPLEX_SINGLE: return visitor(static_cast<SparseArrayRef<std::complex<float>>>(a));
